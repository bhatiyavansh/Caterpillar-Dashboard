...
const HOTSPOTS: Hotspot[] = [
    ...
    steps: [
      {
        ...
        detail:
          "Park on level ground, lower the bucket to the ground, engine off, key removed.",
      ...
      },
      {
        ...
        caution:
          "Hydraulic oil can reach 90 °C. Let it cool for 30 minutes before opening the housing.",
      },
      {
  ...
  },
  {
    ...
    steps: [
      {
        title: "Open the service door",
        detail:
          "Release the two latches on the left-hand engine enclosure door.",
      },
      {
        title: "Release the canister",
        detail:
          "Unclip the three spring clamps and withdraw the end cap. Do not knock the element against the housing.",
      },
      {
        title: "Withdraw the primary element",
        detail:
          "Pull the primary element straight out. Leave the safety element in place unless it is visibly dirty.",
        caution: "Never wash or reuse the element. Fit a new one.",
      },
      {
        title: "Inspect and refit",
        detail:
          "Wipe the housing with a damp cloth, check the new element seal, slide it home and reseat the end cap.",
      },
      {
        title: "Reset the indicator",
        detail:
          "Press the restriction indicator reset button and confirm it reads clear at high idle.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        detail:
          "Travel forward one full track length and stop without braking, so the track settles naturally.",
      },
      {
        title: "Measure the sag",
        detail:
          "Lay a straight edge across the carrier rollers and measure the greatest sag. Target is 20 to 30 mm.",
      },
      {
        ...
        caution:
          "Grease in the adjuster is under high pressure. Never loosen the fitting itself, only the relief valve.",
      },
      {
        title: "Re-measure and confirm",
        detail:
          "Travel another track length, re-measure, and repeat until the sag is inside the range on both sides.",
      },
    ],
  },
];
  ...
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden rounded border border-white/10 bg-ink-950">
      ...
      <svg
        ...
        className="size-full"
        role="img"
        aria-label="CAT 320 excavator, side view"
      >
        <defs>
              ...
              return (
                ...
                >
                  <Icon
                    className={cn(
                      "size-4",
                      active ? "text-cat-500" : "text-muted",
                    )}
                    aria-hidden
                  />
                  <span
                    className={cn(
                      ...
                      active ? "text-cat-500" : "text-zinc-100",
                    )}
                  >
                    {h.label}
                  </span>
        ...
        <section className="flex flex-col overflow-hidden rounded border border-white/10 bg-ink-900">
          <div className="border-b border-white/10 px-4 py-3">
            ...
            <p className="mt-0.5 text-[11px] text-muted">
              {selected.difficulty} · about {selected.duration} ·{" "}
          ...
          {/* Step rail */}
          <ol
            className="flex gap-1 border-b border-white/10 px-4 py-2.5"
            aria-label="Steps"
          >
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <h3 className="text-base font-bold leading-tight text-zinc-50">
                  {current.title}
                </h3>
